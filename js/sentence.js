function sentence_submit(){
    ...
    vaptcha({
        ...
        vaptchaObj.listen('pass', function () {
            ...
            $.post('https://yuri-test-backend.sunxiaochuan258.com/sentence/submit', data, function(r){
                // console.log(r);
                try{
                    r = JSON.parse(r);
                }
    ...
    $('#sentence-submit').on('click', function () {
        ...
        else if(content.length >= 100 || source.length >= 50 || email.length >= 50){
